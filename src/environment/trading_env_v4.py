...
-----------------------------------------------------------------------------
  Trade close:        log-return x scale (asymmetric: losses penalized 1.5x)
  Holding:            0.05 x delta(unrealized PnL) [dense signal]
...
class CryptoTradingEnvV4(gym.Env):
    ...
    def _close_position(self, price: float, reason: str = 'signal') -> float:
        ...
        # Asymmetric loss scale: losses penalized 1.5x to teach caution
